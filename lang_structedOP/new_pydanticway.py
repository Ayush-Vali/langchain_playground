...
class Review(BaseModel):
    ...
    summary: Annotated[
        str,
        Field(description="A brief summary of the review")
    ]

    sentiment: Annotated[
        Literal["pos", "neg"],
        Field(description="Return sentiment of the review either negative, positive or neutral")
    ]
    ...
    name: Annotated[
        Optional[str],
        Field(default=None, description="Write the name of the reviewer")
    ]
